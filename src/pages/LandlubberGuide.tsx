...
function LandlubberContent() {
  const { data, loading, error } = useGuideData('/BRUHsailer/data/guide_data_landlubber.json');
...
export default function LandlubberGuide() {
  return (
    <GuideProvider namespace="landlubber">
      <LandlubberContent />
    </GuideProvider>
  );
}
